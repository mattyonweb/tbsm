"""
Django settings for tbsm project.
...
SECRET_KEY = 'django-insecure-9--c_0=hu_m_wi)a2xtbh3ebmm#el&73z3n^r8t!-396x%8$mt'
...
WSGI_APPLICATION = 'tbsm.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'tbsm.log',
            'formatter': 'verbose',
        },
    },
    'root': {
